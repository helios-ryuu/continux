...
\subsection{Chuyển giao Blue/Green}
Blue/Green deployment là cách vận hành hai phiên bản song song để giảm rủi ro khi thay đổi hệ thống. Blue là phiên bản đang phục vụ truy vấn hiện tại; Green là phiên bản ứng viên đã được chuẩn bị để thay thế. Khi Green đủ sẵn sàng, thao tác chuyển giao (\emph{cutover}) chuyển điểm truy cập công khai từ Blue sang Green. Trong Continux, điểm chuyển giao không phải là pod Kubernetes mà là định nghĩa MV: \texttt{mv\_zone\_stats} là tên công khai ổn định cho phía truy vấn, \texttt{mv\_zone\_stats\_blue} giữ cách tính nền và \texttt{mv\_zone\_stats\_green} áp dụng bộ lọc mới.
