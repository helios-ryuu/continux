...
Future research can pursue four complementary directions:

\begin{itemize}
\item Attach a stable \emph{event identity} from the source JSONL through to the Iceberg sink, so duplicates and losses can be reconciled across the entire path.
